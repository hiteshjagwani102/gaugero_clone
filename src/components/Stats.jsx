...
const Stats = () =>  (
    <section>
        <div className='mt-[100px] mb-[100px] flex flex-row flex-wrap justify-center items-center '>
            ...
            <div className='mt-10'>
                <img className='w-[45vw]' src='https://ik.imagekit.io/aq3ybtarw/landing/water-purifier-min-mb.webp?updatedAt=1680798555447'></img>
            </div>
        </div>
    </section>
  )
